 ...
 *
 * Comprehensive type definitions for managing AI agent lifecycles.
...
/**
 * Hardware profile for availability checking
 */
...
export interface HandlerContext {
  ...
  /** Full conversation object (if applicable) */
  conversation?: {
    id: string;
    messages: Array<{
      role: string;
...
export type AgentHandler = (
  message: { role: string; content: { text?: string }; timestamp?: string },
