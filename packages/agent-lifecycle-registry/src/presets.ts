 ...
 *
 * Pre-defined agents that ship with the registry.
...
export const JEPA_AGENT: AgentDefinition = {
  ...
  metadata: {
    ...
    documentation: 'https://github.com/SuperInstance/Agent-Lifecycle-Registry',
    repository: 'https://github.com/SuperInstance/Agent-Lifecycle-Registry',
    license: 'MIT',
  },
  configSchema: {
    confidence: {
 ...
 * import { registerPresetAgents } from '@superinstance/agent-lifecycle-registry/presets';
 *
