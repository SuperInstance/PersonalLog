 ...
 *
 * Comprehensive error type system for Central Error Manager.
...
/**
 * Base error class for all Central Error Manager errors
 */
 ...
 * WASM-related errors
 */
export class WasmError extends CentralError {
  constructor(
    message: string,
    options: {
      technicalDetails?: string;
 ...
 */
export class StorageError extends CentralError {
  constructor(
    message: string,
    options: {
      technicalDetails?: string;
 ...
 */
export class QuotaError extends CentralError {
  ...
  constructor(
    ...
    super(`Storage quota exceeded: ${usedMB}MB used of ${totalMB}MB`, {
      ...
      userMessage: options.userMessage || `Storage almost full (${usedMB}MB used of ${totalMB}MB). Consider clearing old data or enabling compaction.`,
 ...
 */
export class HardwareDetectionError extends CentralError {
  constructor(
    message: string,
    options: {
      technicalDetails?: string;
 ...
 * Benchmark error
 */
export class BenchmarkError extends CentralError {
 ...
 */
export class CapabilityError extends CentralError {
 ...
 * Network error
 */
export class NetworkError extends CentralError {
  readonly url?: string;
 ...
 * Timeout error
 */
export class TimeoutError extends CentralError {
 ...
 * Validation error
 */
export class ValidationError extends CentralError {
 ...
 * Not found error
 */
export class NotFoundError extends CentralError {
 ...
 * Permission error
 */
export class PermissionError extends CentralError {
...
/**
 * Check if error is a CentralError
 */
export function isCentralError(error: unknown): error is CentralError {
  return error instanceof CentralError;
}
...
export function isRecoverable(error: unknown): boolean {
  return isCentralError(error) && error.recoverable;
}
...
export function shouldFallback(error: unknown): boolean {
  return isCentralError(error) && error.shouldFallback();
}
