...
/**
 * Agent execution states (simplified for standalone package)
 */
export type AgentState = 'idle' | 'running' | 'paused' | 'error' | 'disabled';
...
// ============================================================================
// AGENT TYPES (Minimal for standalone package)
// ============================================================================

/**
 * Minimal agent definition for MPC
 */
...
// ============================================================================
// HARDWARE TYPES (Minimal for standalone package)
// ============================================================================
...
export interface CPUInfo {
  ...
  cores: number;
  /** Estimated concurrency capability */
  concurrency: number;
}
