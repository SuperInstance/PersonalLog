...
Thank you for using In-Browser Vector Search! This document outlines the various ways you can get help, report issues, and engage with the community.
...
If you're new to In-Browser Vector Search:
...
- **[GitHub Discussions](https://github.com/SuperInstance/In-Browser-Vector-Search/discussions)**: Open discussions
...
Need help integrating In-Browser Vector Search into your project?
...
- **GitHub Releases**: https://github.com/SuperInstance/In-Browser-Vector-Search/releases
...
- **[GitHub Projects](https://github.com/SuperInstance/In-Browser-Vector-Search/projects)**: Active development
- **[Milestones](https://github.com/SuperInstance/In-Browser-Vector-Search/milestones)**: Upcoming releases

## Social Media

Follow us for updates:

- **GitHub**: https://github.com/SuperInstance/In-Browser-Vector-Search
- **NPM**: https://www.npmjs.com/package/In-Browser-Vector-Search

## Acknowledgments

Thank you to all our contributors and users who help make In-Browser Vector Search better!
...
We're here to help you succeed with In-Browser Vector Search!
