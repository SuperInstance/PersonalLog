...
- [ ] Manually tested the following scenarios:
  - Tested on Chrome (WebVector enabled)
  - Tested on Firefox (if applicable)
  - Tested on Safari (if applicable)
  - Verified Vector metrics accuracy
  - Checked memory cleanup
  - Verified performance overhead is minimal
...
- [ ] Memory cleanup is properly handled
- [ ] WebVector fallback is considered
- [ ] Vector resource limits are respected
