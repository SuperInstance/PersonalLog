 ...
 * Used by both WASM-accelerated and JavaScript fallback implementations.
 */
...
/** Key point extraction limit (number of user messages to preserve) */
export const KEY_POINT_EXTRACTION_LIMIT = 5

/** Message length importance weight for importance calculation */
export const MESSAGE_LENGTH_WEIGHT = 0.3

/** Reply importance boost for importance calculation */
export const REPLY_IMPORTANCE_BOOST = 0.1

/** Selection importance boost for importance calculation */
export const SELECTION_IMPORTANCE_BOOST = 0.2

/** Importance calculation limit based on message length */
export const MESSAGE_IMPORTANCE_LENGTH_LIMIT = 1000
