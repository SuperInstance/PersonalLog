...
import type { ErrorRecord, ErrorContext } from './types';
...
const DB_NAME = 'PersonalLog_ErrorLogs';
const DB_VERSION = 1;
  ...
  private async pruneOldEntries(): Promise<void> {
    try {
      ...
      if (toDelete > 0) {
        ...
        // Note: This is a simplified version - in production you'd want more efficient deletion
