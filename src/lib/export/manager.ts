 ...
 * Provides a unified interface for exporting PersonalLog data.
 */
...
import { MarkdownConverter, MarkdownOptions } from './converters/markdown'
import { CSVConverter, CSVOptions } from './converters/csv'
import { PDFConverter, PDFExportOptions } from './converters/pdf'
import { HTMLConverter, HTMLOptions } from './converters/html'
import { YAMLConverter, YAMLExportOptions } from './converters/yaml'
...
export class ExportManager {
  ...
  private generateFilename(format: ExportFormat, scope: string): string {
    ...
    return `personallog-${scope}-${date}-${time}.${ext}`
  }
