...
export const DEFAULT_FEATURES: FeatureFlag[] = [
  ...
  // ============================================================
  // JEPA FEATURES (Round 2)
  // ============================================================

  {
    id: 'jepa.transcription',
    name: 'JEPA Transcription',
    description: 'Subtext analysis and enhanced transcripts using Joint Embedding Predictive Architecture',
    category: 'ai' as FeatureCategory,
    state: 'enabled',
    minHardwareScore: 30,
    userOverridable: true,
    experimental: true,
    tags: ['jepa', 'transcription', 'research', 'beta'],
    dependencies: [],
    performanceImpact: 70,
    minRAM: 8,
    minCores: 4,
  ...
  },
  {
    ...
    description: 'Facial expression + voice emotion analysis for enhanced subtext detection',
    category: 'ai' as FeatureCategory,
    state: 'enabled',
    minHardwareScore: 80,
    userOverridable: true,
    experimental: true,
    tags: ['jepa', 'multimodal', 'emotion', 'research', 'beta'],
  ...
  },
  {
    ...
    userOverridable: true,
    experimental: true,
    tags: ['jepa', 'realtime', 'transcription', 'beta'],
    dependencies: ['jepa.transcription'],
  ...
  {
    id: 'jepa.tiny_model',
    name: 'Tiny-JEPA Model',
    description: 'Use lightweight Tiny-JEPA model for transcription (faster, less accurate)',
    category: 'ai' as FeatureCategory,
    state: 'enabled',
    minHardwareScore: 30,
    userOverridable: true,
    experimental: false,
    tags: ['jepa', 'tiny', 'model'],
    dependencies: ['jepa.transcription'],
    performanceImpact: 40,
    minRAM: 4,
  },
  {
    id: 'jepa.large_model',
    name: 'JEPA-Large Model',
    description: 'Use full JEPA-Large model for transcription (slower, more accurate)',
    category: 'ai' as FeatureCategory,
    state: 'enabled',
    minHardwareScore: 50,
    userOverridable: true,
    experimental: false,
    tags: ['jepa', 'large', 'model'],
    dependencies: ['jepa.transcription'],
    performanceImpact: 80,
    minRAM: 16,
    requiresGPU: true,
