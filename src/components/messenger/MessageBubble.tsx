...
export default function MessageBubble({
  ...
  return (
    <div className={`group ${isSystem ? 'mx-auto max-w-md' : ''}`}>
      <div
        onClick={onSelect}
        className={`relative transition-all ${
          isSelected
            ? 'ring-2 ring-blue-500 ring-offset-2 dark:ring-offset-slate-950 rounded-2xl'
            : ''
        ...
        {isSystem ? (
          ...
          <div className="flex justify-start">
            <div className="flex items-end gap-2 max-w-[80%]">
              {/* Avatar */}
              <div className={`w-8 h-8 rounded-full ${authorColor} flex items-center justify-center text-white text-xs font-semibold flex-shrink-0`}>
